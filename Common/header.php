...
<body>
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top" style="background-color:#111;">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/DDU_logo.png" class="logo-image" width="50" height="50">
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item active">
				<a class="nav-link" href="DDU LIBRARY/Library.php">LIBRARY<span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item active">
