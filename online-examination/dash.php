...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="../Teacher/teacher-index.php"><b>Dashboard</b></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        </li><li class="pull-right"> <a href="../Teacher/teacher-index.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Signout</a></li>
...
$result = mysqli_query($con,"SELECT roll_no,first_name,email,mobile_no FROM student_info") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Roll No</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>Mobile no</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['first_name'];
	$mob = $row['mobile_no'];
	...
	echo '<tr><td>'.$c++.'</td><td>'.$gender.'</td><td>'.$name.'</td><td>'.$email.'</td><td>'.$mob.'</td>
