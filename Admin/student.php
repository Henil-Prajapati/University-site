							        ...
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										<div class="row mt-3">
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Adhaar-Card No:</label>
												    <input type="text" name="Adhaar card" data-inputmask="'mask': '99999-9999999-9'" placeholder="XXXXX-XXXXXXX-X" class="form-control">
											    </div>
											</div>
								  		</div>
								  		<div class="row">
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">Gujcet/provisional completion Date: </label>
											        <input type="date" name="matric_complition_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Gujcet/provisional Awarded Date:</label>
												    <input type="date" name="matric_awarded_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Gujcet/provisional Marksheet/Certificate:</label>
						...
						<section class="mt-3">
							<div class="row">
								...
								<div class="col-md-12 pt-5 mb-2">
									...
									<a class="btn btn-success" href="asign-single-student-subjects.php"> Display Student Subject</a>
